      ...
      {agents.map((agent) => (
        <Dialog key={agent.uuid}>
          ...
          <DialogContent>
            ...
            <img src={agent.displayIcon} className="w-32 h-32 mx-auto my-4" alt={agent.displayName} />
            ...
            {agent.abilities.map((ability) => (
              <div key={ability.slot} className="flex items-center space-x-4">
                {ability.displayIcon && <img src={ability.displayIcon} className="w-10 h-10" alt={ability.displayName} />}
                <div>
